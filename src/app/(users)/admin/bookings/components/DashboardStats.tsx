...
const DashboardStats: React.FC<DashboardStatsProps> = ({ 
  ...
  // Use the provided data - handle both direct data and nested data structures
  ...
  const metrics = [
    ...
    {
      title: 'Cancelled',
      value: overview.cancelled_bookings || overview.rejected_bookings || overview.failed_bookings || 0,
      icon: XMarkIcon,
